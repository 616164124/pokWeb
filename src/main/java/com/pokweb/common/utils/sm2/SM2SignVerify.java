...
//import com.zk.util.sm2.ZkSm2Util;
...
//    	 Map keyMap1 = ZkSm2Util.CreateSecretKey();
//         String swPublicKey=(String)keyMap1.get("publicKey");
//         String qyPrivateKey=(String)keyMap1.get("privateKey");
//         System.out.println("swPublicKey=="+swPublicKey+",qyPrivateKey=="+qyPrivateKey);
//         
//         String sourceData="abcdef23121122310tt1";
//         try {
//        	 SM2Sign sign=SM2SignVerify.sign(SM2Util.hexToByte(qyPrivateKey), sourceData.getBytes());
//        	 String signstr=sign.getSm2_sign();
//        	 System.out.println("signstr:"+signstr);
//        	 
//        	 sign=SM2SignVerify.validateSign(SM2Util.hexToByte(swPublicKey), sourceData.getBytes(), SM2Util.hexToByte(signstr));
//        	 System.out.println("signstr:"+sign.isVerify());
//		} catch (Exception e) {
