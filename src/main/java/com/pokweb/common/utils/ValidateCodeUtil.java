...
//        saveCode(sessionid, randomStr);
    ...
    //    将验证码放入redis
    public void saveCode(String sessionid,String randomStr){
        RedisTemplate<String, String> redisTemplate = new RedisTemplate<>();
        redisTemplate.opsForValue().set("sessionId:"+sessionid, randomStr,5,TimeUnit.MINUTES);
